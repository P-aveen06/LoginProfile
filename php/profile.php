    ...
    <?php if (!empty($row)) : ?>
        <div class="row col-lg-8 mx-auto mt-5 border rounded shadow-lg p-2 pofile">
            <div class="profile-image col-md-4 text-center">
                <img src="<?php echo get_image_edit($row['image'])?>" alt="Profile img" style="width: 180px;
            ...
            <div class="col-md-8 user_detail">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td id="firstName"><input value="<?=$row['firstName']?>" type="text" class="from-control" placeholder="First Name"></td>
                    </tr>
                    <tr>
                        <th><i class="bi bi-person-circle"></i> Last Name</th>
                        <td id="lastName"><input value="<?=$row['lastName']?>" type="text" class="from-control" placeholder="Last Name"></td>
                    </tr>
                    <tr>
                        <th><i class="bi bi-envelope"></i> User Email</th>
                        <td id="email"><input value="<?=$row['email']?>" type="email" class="from-control" placeholder="Email"></td>
                    </tr>
                    <tr>
                        <th><i class="bi bi-phone"></i> Phone Number</th>
                        <td id="phoneNumber"><input value="<?=$row['phoneNumber']?>" type="number" class="from-control" placeholder="Phone Number"></td>
                    </tr>
                    <tr>
